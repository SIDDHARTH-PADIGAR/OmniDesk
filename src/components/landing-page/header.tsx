...
const Header = () => {
  ...
  return (
    <header className='p-4 flex justify-center items-center '>
        ...
        <Image src={Logo} alt= 'OmniDesk Logo' width={25} height={25}/>
        <span className='font-semibold dark:text-white'> OmniDesk.</span>
        </Link>
        <NavigationMenu className='hidden md:block'>
            <NavigationMenuList className='gap-6 '>
                ...
                'text-xl': true,
                    ...
                    <NavigationMenuContent>
                        <ul className='grid gap-3 p-6 md:w-[300px] lg:[500px] lg:grid-cols-[.75fr_1fr]'>
                            ...
                            <ListItem href='#' title='Typography'>
                                Styles, headings, paragraphs, lists...etc
                            </ListItem>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid w-[300px] gap-3 p-4  md:grid-row-2  ">
                <ListItem
                  title="Pro Plan"
                  href={'#'}
                >
                  Unlock the full potential through collaboration.
                </ListItem>
                <ListItem
                  title={'Free Plan'}
                  href={'#'}
