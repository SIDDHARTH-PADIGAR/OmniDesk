...
import OmniDeskProfileIcon from '../icons/omnideskProfileIcon';
...
const SettingsForm = () => {
  ...
  const redirectToCustomerPortal = () => {
    ...
    console.log('Button clicked. Starting redirection...');
    
    try {
      const url = 'https://billing.stripe.com/p/login/test_14k4gVcoOcZk8BWbII';
      ...
      console.log('Finished redirection process.');
    }
  };
  //add collaborators
